...
// console.log("a:", a);
// console.log("b:", b);
// [a, b] = [b, a];//присваивание в JavaScript
// console.log("a:", a);
// console.log("b:", b);
// let mas = [5, 3, 2];
// for (let i = 0; i < mas.length; i++) {
//     mas[i] = 0;
// }
//CONST-используется при работе с массивами и объектами
...
// function Person(name, age) {//Функция конструктор
//     this.name = name;
//     this.age = age;
// }
...
// console.log(triangle1.s());
// console.log(triangle1.p());
// const triangle2 = new triangle(8, 9, 10);
// console.log(triangle2.s());
// console.log(triangle2.p());
...
//Сеттеры и гетеры-Получить данные и установить данные
...
// document.writeln(people.fullName + "<br>");
// console.log("Анна Петрова".split(/\s+/));
...
//     get sender() {//только выводит
//         return "Почта : " + this._sender;
//     }
//     set sender(val) {//только принимает
...
// getFullName() {//скобки если без get
//     return "ФИО работника :" + this._name + " " + this._surname;
...
//     stop() {
//         this.speed = 0;
//         document.writeln(`${this.speed} стоит. <br>`)
//     }
// }
// class Rabbit extends Animal {//расширяет,наследует
//     constructor(name, earLength) {//если класс ссылается на другой класс,то нельзя использовать конструктор!
//         super(name);//c использованием этой строки не будет выдавать ошибок
...
//     }
//     stop() {
//         super.stop();//ссылка на родительский класс,который мы указали при задании класс словом extends
//         this.hide();
...
// console.log(User.isNameTaken("Игорь"));
...
//Планировщик задач
// class Task {
//     constructor(title = Task.getDefaultTitle()) {//устанавливаем значение по умолчанию
//         this.title = title;
//         this.done = false;
//         Task.count++;
...
// let task2 = new Task("Выучить fameworks");
// let task3 = new Task();
...
// c.fillStyle="white";
// c.fillRect(45,45,50,50);
// c.strokeStyle="#3f3f3f";
// c.strokeRect(50,50,40,40);
...
// Треугольник
// c.beginPath();
// c.moveTo(80,50);//коорд нач точки
// c.lineTo(100,80);//конечн коорд точки
// c.lineTo(100,30);
...
// // c.moveTo(300,80);
// c.moveTo(300, 80);
// // c.arc(300,80,40,0,Math.PI/2,false);
...
// c.beginPath();
// c.moveTo(180, 260);//начало-среднее
// c.bezierCurveTo(240, 200, 220, 320, 290, 260);//верх,низ,бок
// c.closePath();
// c.strokeStyle = "red";
// c.stroke();
...
// c.textAlign = "center";
// //тень и размытие
// c.shadowOffsetX = 3;//тень X
// c.shadowOffsetY = 3;//тень Y
// c.shadowColor = "#AAA";//тень
...
//     c.drawImage(pic,160,0,300,130);//растягивание картинки
// })
...
// c.globalAlpha = 0.5;
// c.translate(50,25);
// c.rotate(.52);//поворот на 30 град
// c.scale(1.5,1.5);//масштабирование
// c.fillRect(50, 50, 100, 100);
...
// canvas.addEventListener("mousedown", function (e) {//нажатие мыши
...
// canvas.addEventListener("mouseup", function (e) {//отпускание  мыши
//     const w = canvas.width;
//     const h = canvas.height;
//     c.lineTo(mouse.x, mouse.y);
//     draw = false;
